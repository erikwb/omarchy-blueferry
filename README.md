...
The widget expects `blueferry-backend` and `blueferry-quickshell` 0.7.8 or
newer. If they are missing, clicking it opens a terminal with the source-build
commands; it does not run them for you. Once they are installed, clicking a
conversation opens that thread in the full client.
